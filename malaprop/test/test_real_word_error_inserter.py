...
class RealWordErrorInserterTest(unittest.TestCase):
    ...
    def test_corrupt(self):
        ...
        expected_dict = {\
            ...
            'adversarial' : '["Accordingly, \\"libertarian socialism\\" is sometimes used as a synonym for socialist anarchism, to distinguish it from \\"individualist libertarianism\\" (individualist anarchism).", "Accordingly, \\"libertarian socialist\\" it sometimes used as a synonym for socialist anarchism, to distinguish it from \\"individualist libertarianism\\" (individualist anarchism)."]\n["On the other hand, some use \\"libertarianism\\" to refer to individualistic free-market philosophy only, referring to free-market anarchism a \\"libertarian anarchism.\\"", "On the other hand, some use \\"libertarianism\\" to refer to individualistic free-market philosophy only, referring to free-market anarchism as \\"libertarian anarchism.\\""]\n',\
            'key' : '01'}
