...
class RealWordVocabExtractor():
    ...
    def extract_real_words(self):
        ...
        There is also a temporary ban on words containing unicode
        characters, while I figure out how to get
        DamerauLevenshteinDerivor, which is written in C to handle
        unicode.
        """
